...
// 
// Estudo de caso genérico sobre aerogerador FEEL 900kW, com torre de 75m,
...
turbina.fator_correcao_gerador = 1;     //Fator de correção de massa do gerador, para turbina EWT
turbina.fator_correcao_custo = 1.336*2/2.3;   //Fator de correção de custo, para turbina EWT
