...
// 
// Estudo de caso para determinar o máximo preço da turbina FEEL 900kW, de forma
// que o payback descontado seja no máximo 6 anos. Solicitado por Paulo Furlan.
//
// Data: 30/04/2013
//
// ----------------------------- PARÂMETROS ------------------------------------
...
projeto.preco_energia = 160;            //Preço da energia (R$/MWh)
...
projeto.custo_MW = 1.96e6/(0.9*0.7);     //Custo do MW instalado (R$/MW)
