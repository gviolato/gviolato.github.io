...
// 
// Estudo de caso genérico para determinar mínima velocidade de vento viável,
// aerogerador FEEL 900kW, com torre de 50m, considerando sistema de
...
projeto.vel_media = 6.2;                //Velocidade média anual de vento (m/s)
...
conta.consumo_f_ponta = 160;            //Consumo médio energia elétrica fora de ponta (MWh)
...
turbina.altura_hub = 50;                //Altura do hub (m)
