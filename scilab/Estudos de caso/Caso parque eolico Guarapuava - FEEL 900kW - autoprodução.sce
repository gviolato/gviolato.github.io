...
projeto.preco_energia = 130;            //Preço da energia (R$/MWh)
...
turbina.fator_correcao_custo = 1.336;   //Fator de correção de custo, para turbina EWT
...
custos.TUST = 2*2.54e3;                   //Custo de transporte de energia, com desconto de 50% (R$/MW/mês)
