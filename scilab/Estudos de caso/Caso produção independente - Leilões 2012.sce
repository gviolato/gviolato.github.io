...
// 
// Estudo de caso considerando cenários dos últimos leilões. 15º Leilão de
// Energia Nova (Edital nº 06/2012-ANEEL)
//
// Data: 02/05/2013
//
// ----------------------------- PARÂMETROS ------------------------------------
...
projeto.potencia = 28.8;                //Potência instalada (MW)
...
projeto.preco_energia = 87.77;          //Preço da energia (R$/MWh)
...
projeto.fator_capacidade = 0.5903;      //Fator de capacidade do parque eólico (MWh/ano)
...
projeto.custo_MW = 2700347.22;          //Custo do MW instalado (R$/MW)
...
turbina.conceito = 1;                   //Conceito da turbina [1-Three-Stage Drive with High-Speed Generator;
                                        ...
                                        //4-Direct Drive]
turbina.modelo = 0;                     //Modelo da turbina [1-FEEl 900kW]
